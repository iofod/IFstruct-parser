...
exports.RegModelVar = exports.IFstruct = void 0;
...
exports.RegModelVar = RegModelVar;
class IFstruct {
    constructor(json) {
        Object.defineProperty(this, "CTT", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: void 0
    ...
    parseModelStr(target, hid) {
        if (typeof target != 'string')
            return target;
        if (target.indexOf('# ') == 0)
            return this.parseModelExp(target, hid);
        if (target.slice(0, 1) != '$')
            return target;
