...
const IFlevel = `<div v-if="canRender()" class="wrap" :hid="hid" :clone="clone">
<slot></slot>
</div>`
...
const IFtext = `<p class="U-text" ${prefix}>
{{ GET('msg') }}
</p>`
const IFlink = `<a class="U-link" :href="GET('link')" target="_blank" ${prefix}>
{{ GET('msg') }}
</a>`
const IFinput = `<input
class="U-input"
